...
- 筆記 AI 整理功能全面升級，支援「心智圖」、「層次化重點」、「費曼技巧」、「問答式學習」、「記憶宮殿法」、「對比分析整理」、「格式化補強」等多種 AI 結構化版面，所有結果皆以美觀卡片、表格、標籤等方式呈現。
- 對比分析整理全新視覺化，異同點、關聯性、優缺點一目了然。
- 筆記頁面支援多版本 AI 整理結果切換、移除、重新生成。
- 前端互動體驗優化，所有整理類型皆有專屬版面。
- 其他細節優化與穩定性提升。
