...
class DatabaseManager:
    ...
    def _ensure_columns_exist(self):
        ...
        cur = self.conn.cursor()
        try:
            cur.execute('ALTER TABLE questions ADD COLUMN title TEXT')
            self.conn.commit()
        except sqlite3.OperationalError:
            # 欄位已存在，忽略錯誤
            pass
        ...
        try:
            cur.execute('ALTER TABLE questions ADD COLUMN mindmap_code TEXT')
            self.conn.commit()
        except sqlite3.OperationalError:
            # 欄位已存在，忽略錯誤
            pass
        ...
        try:
            cur.execute('ALTER TABLE questions ADD COLUMN guidance_level TEXT')
            self.conn.commit()
        except sqlite3.OperationalError:
            pass
        ...
        try:
            cur.execute('ALTER TABLE documents ADD COLUMN original_content TEXT')
            self.conn.commit()
        except sqlite3.OperationalError:
            # 欄位已存在，忽略錯誤
            pass
        ...
        try:
            cur.execute('ALTER TABLE documents ADD COLUMN key_points_summary TEXT')
            self.conn.commit()
        except sqlite3.OperationalError:
            # 欄位已存在，忽略錯誤
            pass
        ...
        try:
            cur.execute('ALTER TABLE documents ADD COLUMN quick_quiz TEXT')
            self.conn.commit()
        except sqlite3.OperationalError:
            # 欄位已存在，忽略錯誤
            pass
